    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 lg:py-14 text-center flex flex-col items-center justify-center">
        ...
        <p className="mt-2.5 sm:mt-3 text-slate-100 text-xs sm:text-sm md:text-base max-w-2xl font-medium leading-relaxed drop-shadow-sm">
          Send your product list or samples for direct factory pricing and reliable global container delivery.
        </p>
        ...
        <div className="mt-6 sm:mt-7 flex flex-wrap items-center justify-center gap-3.5 sm:gap-4">
          ...
          <button
            ...
            className="group w-fit bg-[#3B82F6] hover:bg-[#DBEAFE] text-white hover:text-black font-bold pl-5 sm:pl-6 pr-2 py-2.5 sm:py-3 rounded-full inline-flex items-center justify-center gap-3 text-xs sm:text-sm md:text-base shadow-xl transition-all transform hover:scale-105 cursor-pointer whitespace-nowrap"
          >
          ...
          >
            ...
            <span className="transition-colors">Call {COMPANY_INFO.phones.indiaPrimary}</span>
          </a>
        </div>
      </div>
    </section>
